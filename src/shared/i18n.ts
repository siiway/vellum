...
const en: MessageMap = {
  ...
  "ui.languages.translating": "Translating",
  "ui.languages.translateAll": "Translate all",
  "ui.languages.translateRepo": "Translate all pages in every repo to this language",
  "ui.translateRepo.title": "Translate to {locale}",
  "ui.translateRepo.translating": "Translating...",
  "ui.translateRepo.phaseSidebar": "Translating sidebar & index...",
  ...
  "ui.translateTasks.title": "Translation tasks",
  "ui.translateTasks.subtitle": "Active and completed translation jobs across all repos.",
  "ui.translateTasks.noJobs": "No translation jobs found.",
  "ui.translateTasks.status.running": "Running",
  "ui.translateTasks.status.complete": "Complete",
  "ui.translateTasks.status.cancelled": "Cancelled",
  "ui.translateTasks.status.error": "Error",
...
const zh: MessageMap = {
  ...
  "ui.languages.notTranslatedYet": "尚未翻译",
  "ui.languages.empty": "本站未配置任何语言。",
  "ui.languages.current": "当前",
  "ui.languages.source": "源语言",
  ...
  "ui.languages.translating": "正在翻译",
  "ui.languages.translateAll": "翻译全部",
  "ui.languages.translateRepo": "将所有仓库的全部页面翻译为此语言",
  "ui.translateRepo.title": "翻译为 {locale}",
  "ui.translateRepo.translating": "正在翻译...",
  "ui.translateRepo.phaseSidebar": "正在翻译侧边栏和索引...",
  ...
  "ui.translateTasks.title": "翻译任务",
  "ui.translateTasks.subtitle": "所有仓库的翻译任务。",
  "ui.translateTasks.noJobs": "没有翻译任务。",
  "ui.translateTasks.status.running": "进行中",
  "ui.translateTasks.status.complete": "已完成",
  "ui.translateTasks.status.cancelled": "已取消",
  "ui.translateTasks.status.error": "错误",
